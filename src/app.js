...
function calculate() {
	...
	const tips = {
		...
		Inset:
			"Distance from the inner rim lip to the hub mounting face — also called backspacing (mm). Too little and the wheel fouls inner suspension.",
		"Speedo Error":
	...
	const rows = [
		...
		["Ride Height Gain", "0.0 mm", `${fmt(rhGain)} mm`, signed(rhGain, "mm")],
